...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => 'fruit_img/strawberry.png',
        ...
        DB::table('products')->insert([
            'name' => 'スイカ',
            'price' => 700,
            'image' => 'fruit_img/watermelon.png',
